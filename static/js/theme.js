    ...
    "use strict";
      ...
      // -------------------- Remove Placeholder When Focus Or Click
        ...
        if (!isHomePage && $heroWrapper.length > 0) {
            // Aggressively remove all existing manual breadcrumbs to avoid duplicates
            $('.pager, .breadcrumb, .vjs-hero-breadcrumb, nav[aria-label="breadcrumb"]').remove();
            ...
            var breadcrumbHTML = `
                <div class="vjs-dynamic-breadcrumb">
                    <div class="bc-text">
            ...
            // Ensure wrapper is positioned relative to anchor absolute elements
            $heroWrapper.css("position", "relative");
            // Also ensure the parent is relative if we appended to .container
            $heroWrapper.parent().css("position", "relative");
